...
impl CreatureResources {
    pub fn new(
        spritesheet: SpriteSheet<AnimationType>,
        sounds: [Option<Chunk>; CreatureSound::COUNT],
    ) -> Self {
        Self {
            spritesheet,
...
pub struct CreatureSounds([Option<Chunk>; CreatureSound::COUNT]);

impl CreatureSounds {
    pub fn get(&self, sound_type: CreatureSound) -> Option<&Chunk> {
